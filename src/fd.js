    ...
    <div style={{ background: 'black' }}>
      <center>
        ...
        <table style={{ border: '5px solid white' }}>
          <thead>
            <tr>
              <th style={{ border: '2px solid white', background: 'black', color: 'white' }}>Sno</th>
              <th style={{ border: '2px solid white', background: 'black', color: 'white' }}>Profile Pic</th>
              <th style={{ border: '2px solid white', background: 'black', color: 'white' }}>First Name</th>
              <th style={{ border: '2px solid white', background: 'black', color: 'white' }}>Last Name</th>
              <th style={{ border: '2px solid white', background: 'black', color: 'white' }}>Gender</th>
              <th style={{ border: '2px solid white', background: 'black', color: 'white' }}>E-mail</th>
              <th style={{ border: '2px solid white', background: 'black', color: 'white' }}>Username</th>
              <th style={{ border: '2px solid white', background: 'black', color: 'white' }}>Domain</th>
              <th style={{ border: '2px solid white', background: 'black', color: 'white' }}>IP</th>
              <th style={{ border: '2px solid white', background: 'black', color: 'white' }}>University</th>
            </tr>
          </thead>
          <tbody>
